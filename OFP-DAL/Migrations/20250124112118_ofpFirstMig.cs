...
{
    /// <inheritdoc />
    public partial class ofpFirstMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndAnswer = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReportUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReportedAnswerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportAnswers_Answers_ReportedAnswerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportComments_Comments_ReportedCommentId",
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Badge", "ConcurrencyStamp", "CreatedDate", "DeletedTime", "Email", "EmailConfirmed", "FirstName", "Gender", "LastName", "Likes", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Region", "SecurityStamp", "Status", "TwoFactorEnabled", "UpdatedDate", "UserName" },
                values: new object[] { "1", 0, 0, "25f92e6f-5f07-43eb-96ff-daa35e885b28", new DateTime(2025, 1, 24, 11, 21, 18, 70, DateTimeKind.Utc).AddTicks(1998), null, "admin@admin.com", true, "Super", "Male", "Admin", 0, false, null, "ADMIN@ADMIN.COM", "ADMINYASIN", "AQAAAAIAAYagAAAAECSEJ6S8HAIx89YIodlSru7JncLJlDRqlXDJDggmmv3lxsTMVlXusTo31GfVBRlc3w==", null, false, "Türkiye", "b027b015-a7df-4ad9-9c47-ee1d0f6a52f6", 0, false, null, "AdminYasin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportAnswers_ReportedAnswerId",
                table: "ReportAnswers",
                column: "ReportedAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportComments_ReportedCommentId",
