...
namespace OFP_SERVICE.Services.Interfaces
{
    ...
    {
        /// <summary>
        /// ProblemCreateDTO nesnesi ile yeni bir PROBLEM oluşturma.
        /// </summary>
        /// <param name="problem"></param>
        /// <returns></returns>
        Task<Problem> CreateProblemAsync(ProblemCreateDTO problem);

        /// <summary>
        /// ProblemUpdateDTO'ye ait Problem nesnesini bulup güncelleme.
        /// </summary>
        /// <param name="updateProblem"></param>
        /// <returns></returns>
        Task<Problem> UpdateProblemAsync(ProblemUpdateDTO updateProblem);
