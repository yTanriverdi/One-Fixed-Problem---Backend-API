...
namespace OFP_SERVICE.Services.Interfaces.LogService
{
    public interface ILogService
    {
        ...
        /// <returns></returns>
        Task<Log> CreateLogAsync(string logContent, string userId = null, bool isError = false, string controller = null);
